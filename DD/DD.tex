...
The Data layer consists of a relational DBMS. The relational model is a widely used design and there are several valid options, 
both open source and not, for what concerns the choice of the Management System.
...
\begin{tabular}{| c || c | c |}
    ...
    \hline
    Report a violation & \textit{Medium} & \textit{Low} \\

    \hline
    Consult older reports & \textit{Medium} & \textit{Low} \\

    \hline
    Use external map services & \textit{Low} & \textit{Low} \\
