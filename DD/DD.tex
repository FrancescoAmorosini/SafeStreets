...
\begin{tabularx}{\linewidth}{| c || X |}
    ...
    $\bullet$ {[R.10]} Notify the Authorities whenever a new Report involving their municipality is submitted. \\
	...
	\hline
	\large{MISSING COMPONENT} & \parbox{0.45\textwidth}{ \vspace{2mm}
