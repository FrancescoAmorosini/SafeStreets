...
\noindent This structure provides several advantages.The Server can be replicated to have more scalability. 
...
\begin{itemize}
	\item The \textit{presentation tier} provides an interface that allows the users to consult data and result of services executed in a different layer. 
...
\end{itemize}
\begin{center}\large{\textit{Motivations}}\end{center}
A multi-tier application architecture provides a model with several advantages: developers can create flexible and reusable 
...
\begin{center}\large{\textit{Motivations}}\end{center} 
In this case the application is thought for mobile phone which could not have great power of computation. Whit 
...
\begin{center}\large{\textit{Motivations}}\end{center} 
MVC allows full encapsulation of object. This means that each component can be changed without creating issues to other components.
...
\begin{center}\large{\textit{Motivations}}\end{center} 
It is useful to organize the requests of multiple clients and to save frequent requested informations. 
