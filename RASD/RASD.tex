...
\begin{itemize}
	...
	Once the report has been confirmed, the System enters the status \texttt{Ready to Store}: the Report is exported into the database, where it can be retrieved and dectypted only by the Information Manager.
