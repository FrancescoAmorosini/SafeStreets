...
\begin{table}[!ht]
		...
		\begin{tabular}{|C{3.5cm}||C{3.5cm}||C{3.5cm}|}
			...
			\midrule
			&\textbf{Build statistics}$^{2}$: computation of statistics to find unsafe areas, to see which veichles commit multiple infractions and also to monitor the trend of issued tickets.&\textbf{Credential validation}: to grant different levels of visibility to Citizen and Authorities\\ 
			\midrule			
...
\begin{itemize}
	...
	\item Alloy documentation: \url{http://alloy.lcs.mit.edu/alloy/documentation.html}.
...
\begin{itemize}
	...
	\item \textit{User}: a registered Guest who has to logged either as Citizen or as Authority. He/She is recognized by the System through an ID and can access any feature of the application. %and can retrieve his/her personal data from any device with the app installed just providing credentials.
	...
	\item \textit{Authority}: someone who logged-in with his credentials. He/she is notified every time a new Report regarding its municipality is stored by the System. He/She can access and download those Reports he is interested in handling.
\end{itemize}
...
\begin{itemize}
	...
	correct.
	\item {[D.4]} The badge number of the Authority is assumed to be valid.
\end{itemize}
...
\begin{tabularx}{\linewidth}{| l | X |}
	...
	\textbf{Flow of Events} & \parbox{0.7\textwidth}{	
		\begin{enumerate}
			\item The \textbf{\textit{Guest}} opens SafeStreets application, taps the Sign Up button and and selects a role between Citizen or Authority.
...
\begin{tabularx}{\linewidth}{| l | X |}
	...
	\textbf{Flow of Events} & \parbox{0.7\textwidth}{\begin{enumerate}
			...
			\item The \textbf{\textit{Report Manager}} checks if the report has bee correctly compiled.		
	\end{enumerate}}\\
...
\begin{tabularx}{\linewidth}{| l | X |}
	...
	\hline
	\textbf{Description} & The \textbf{\textit{Report Manager}} recieves a report from a Citizen and notifies the Authorities about this. Then the report is stored in a database.\\
	...
	\textbf{Flow of Events} & \parbox{0.7\textwidth}{\begin{enumerate}
			...
			\item The \textbf{\textit{Report Manager}} notifis the Authorities of the municipality where the violation occurred about the report.
...
\begin{figure}[ht!]
\begin{center}
\includegraphics[width=\textwidth]{./img/Login1SD.png}
\end{center}
...
%%%%%%%%%%%%%%%%%
\begin{center}
	\textbf{Investigation of a Report}
\end{center}
\begin{tabularx}{\linewidth}{| l | X |}
	\hline
	\textbf{ID} & UC6\\
	...
	\hline
	\textbf{Description} & An \textbf{\textit{Authority}} demands the \textbf{\textit{Information Manager}} to see a certain report to investigate it.\\
	
	\hline
	\textbf{Actors} & \textbf{\textit{Authority}} and \textbf{\textit{Information Manager}}\\
	
	\hline
	\textbf{Preconditions} & The \textbf{\textit{Authority}} has been notified by the Report Manager about a new violation. He/She wants to investigate it. \\
	
	\hline
	\textbf{Flow of Events} & \parbox{0.7\textwidth}{\begin{enumerate}
			\item The \textbf{\textit{Authority}} taps on the interested Notification to download the full Report.
			\item The \textbf{\textit{Information Manager}} loads the selected Report, decrypts it and sends a copy of it to the \textbf{\textit{Authority}}.
			\item The \textbf{\textit{Authority}} has now access to all the documentation about the violation and can handle it accordingly. 
			
	\end{enumerate}}\\
	
	\hline
	\textbf{Postconditions} & The \textbf{\textit{Authority}} is now able to investigate the reported violation.\\
