...
\begin{table}[!ht]
	\begin{tabular}{|C{.14\textwidth}|C{.12\textwidth}||C{.60\textwidth}|}
		...
		\midrule
		\vspace{1.3cm} 22.11.2019 \vfill & \vspace{1.3cm} 1.1 \vfill & \begin{itemize}
...
The System (and all its components) should guarantees a 99.9\% (\textit{"three-nines"}) of reliability, so that only 10.08 minutes of downtime per week are allowed. In order to guarantee the continuity of the service, it must be ensured that the System is fault tolerant.
